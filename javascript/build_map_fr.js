    ...
    g.append("g")
        ...
        function clicked(d) {
            ...
            if(prov_bool){
                ...
                //1st table, 2nd row
                d3.select("#name_csd").text("s.o.")
                d3.select("#name_o_p").text(text["prov_name_fr"])

                //1st table, 3rd row
                d3.select("#FOL_pop_csd").text("s.o.")
                ...
                //1st table, 4th row
                d3.select("#name_csd").text("s.o.")
                d3.select("#FOL_ps_pop_csd").text("s.o.")
                ...
                //1st table, 5th row
                d3.select("#FOL_appl_csd").text("s.o.")
                ...
                //2nd table, 2nd row
                d3.select("#k_name_csd").text("s.o.")
                d3.select("#k_name_o_p").text(text["prov_name_fr"])

                d3.select("#csd_th_2").text("Province")
                d3.select("#name_csd").text("s.o.")
                d3.select("#name_o_p").text(text["prov_name_fr"])
                //2nd table, 3rd row
                d3.select("#k_pop_csd").text("s.o.")
                ...
                //2nd table, 4th row
                d3.select("#k_ps_pop_csd").text("s.o.")
                ...
                d3.select("#name_o_p").text(text["OLMC_fr"])

                d3.select("#FOL_pop_csd").text(formatDecimalComma(+text["FOL_csd_census_pop"])+ " (" + text["sh_FOL_csd_census_pop"] + ")")
                d3.select("#FOL_pop_o_p").text(text["OLMC_fr"] === "s.o." ? "s.o." : formatDecimalComma(+text["FOL_OLMC_census_pop"])+ " (" + text["sh_FOL_OLMC_census_pop"] + ")")
                d3.select("#FOL_pop_can").text(formatDecimalComma(+text["FOL_CAN_census_pop"])+ " (" + text["sh_FOL_CAN_census_pop"] + ")")
                //1st table, 2nd row
                d3.select("#csd_th_1").text("Communauté minoritaire de langue officielle")
                d3.select("#FOL_ps_pop_csd").text(formatDecimalComma(+text["FOL_csd_ps_pop"])+ " (" + text["sh_FOL_csd_ps_pop"] + ")")
                d3.select("#FOL_ps_pop_o_p").text(text["OLMC_fr"] === "s.o." ? "s.o." : formatDecimalComma(+text["FOL_OLMC_ps_pop"]) + " (" + text["sh_FOL_OLMC_ps_pop"] + ")")
                d3.select("#FOL_ps_pop_can").text(formatDecimalComma(+text["FOL_CAN_ps_pop"])+ " (" + text["sh_FOL_CAN_ps_pop"] + ")")
                //1st table, 3rd row
                d3.select("#FOL_appl_csd").text(formatDecimalComma(+text["FOL_csd_appl"]) + " (" + text["sh_FOL_csd_appl"] + ")")
                d3.select("#FOL_appl_o_p").text(text["OLMC_fr"] === "s.o." ? "s.o." : formatDecimalComma(+text["FOL_OLMC_appl"]) + " (" + text["sh_FOL_OLMC_appl"] + ")")
                d3.select("#FOL_appl_can").text(formatDecimalComma(+text["FOL_CAN_appl"])+ " (" + text["sh_FOL_CAN_appl"] + ")")

                //2nd table, 1st col
                d3.select("#k_name_csd").text(text["cdname"])
                d3.select("#k_name_o_p").text(text["OLMC_fr"])

                d3.select("#k_pop_csd").text(formatDecimalComma(+text["csd_census_pop"])+ " (" + text["sh_csd_census_pop"] + ")")
                d3.select("#k_pop_o_p").text(text["OLMC_fr"] === "s.o." ? "s.o." : formatDecimalComma(+text["OLMC_census_pop"])+ " (" + text["sh_OLMC_census_pop"] + ")")
                d3.select("#k_pop_can").text(formatDecimalComma(+text["CAN_census_pop"])+ " (" + text["sh_CAN_census_pop"] + ")")
                //2nd table, 2nd col
                d3.select("#csd_th_2").text("Communauté minoritaire de langue officielle")
                d3.select("#k_ps_pop_csd").text(formatDecimalComma(+text["csd_ps_pop"])+ " (" + text["sh_csd_ps_pop"] + ")")
                d3.select("#k_ps_pop_o_p").text(text["OLMC_fr"] === "s.o." ? "s.o." : formatDecimalComma(+text["OLMC_ps_pop"])+ " (" + text["sh_OLMC_ps_pop"] + ")")
                d3.select("#k_ps_pop_can").text(formatDecimalComma(+text["CAN_ps_pop"])+ " (" + text["sh_CAN_ps_pop"] + ")")
                //2nd table, 3rd col
                d3.select("#k_appl_csd").text(formatDecimalComma(+text["csd_appl"])+ " (" + text["sh_csd_appl"] + ")")
                d3.select("#k_appl_o_p").text(text["OLMC_fr"] === "s.o." ? "s.o." : formatDecimalComma(+text["OLMC_appl"])+ " (" + text["sh_OLMC_appl"] + ")")
                d3.select("#k_appl_can").text(formatDecimalComma(+text["CAN_appl"])+ " (" + text["sh_CAN_appl"] + ")")
